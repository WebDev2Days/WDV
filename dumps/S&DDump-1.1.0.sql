...
CREATE TABLE `tblcart` (
  ...
  KEY `intCartAccNo_idx` (`intCartAccNo`),
  KEY `intCartProdID_idx` (`intCartProdID`),
  CONSTRAINT `intCartAccNo` FOREIGN KEY (`intCartAccNo`) REFERENCES `tbluser` (`intAccNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `intCartProdID` FOREIGN KEY (`intCartProdID`) REFERENCES `tblproduct` (`intProdID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `tblorder` (
  ...
  KEY `intOrderAccNo_idx` (`intOrderAccNo`),
  KEY `intOrderProdID_idx` (`intOrderProdID`),
  CONSTRAINT `intOrderAccNo` FOREIGN KEY (`intOrderAccNo`) REFERENCES `tbluser` (`intAccNo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `intOrderProdID` FOREIGN KEY (`intOrderProdID`) REFERENCES `tblproduct` (`intProdID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblproduct` (
  ...
  KEY `intProdCatID_idx` (`intProdCatID`),
  CONSTRAINT `intProdCatID` FOREIGN KEY (`intProdCatID`) REFERENCES `tblcategories` (`intCatID`) ON DELETE NO ACTION ON UPDATE NO ACTION
